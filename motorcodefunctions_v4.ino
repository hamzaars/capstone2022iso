...
void loop() {
  motormoving_fixedSteps_backward(LOW,LOW,LOW,M0_dispenser, M1_dispenser,M2_dispenser,switch_dispenser_top,switch_dispenser_bottom ,stepPin_dispenser, dirPin_dispenser,50,400);
  exit(0); 
}
